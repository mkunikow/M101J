...
public class BlogPostDAO {
    ...
    public List<DBObject> findByDateDescending(int limit) {
        ...
        posts = postsCollection.find().sort(new BasicDBObject().append("date",-1)).limit(limit).toArray();
   ...
   // White space to protect the innocent
    ...
    public void addPostComment(final String name, final String email, final String body,
        ...
        BasicDBObject updateQuery = new BasicDBObject("$set", new BasicDBObject("comments", comments));

        BasicDBObject whatToUpdateQuery = new BasicDBObject().append("permalink", permalink);
        postsCollection.update(whatToUpdateQuery, updateQuery);
    }
